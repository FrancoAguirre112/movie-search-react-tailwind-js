      ...
      <section id="features">
        <div className="container flex flex-col-reverse items-top justify-between px-6 mx-auto mt-16 md:space-x-6 md:flex-row">
          ...
          <div className="flex flex-col space-y-11 md:w-1/2">
            ...
            <p className="text-md text-center text-gray-600 md:text-right">
          ...
          <div className="flex flex-col md:flex-row md:space-x-5">
            <TestimonialCard img={testimonial1} name={'Totallyr Eal'}>
              <p>
                ...
                cloud of cinematic enlightenment. My chakras aligned as I
                embarked on a soulful journey through movie trailers. Pure
                transcendence!"
              </p>
            </TestimonialCard>
            <TestimonialCard img={testimonial2} name={'Realhu Man'}>
              <p>
                ...
                allowing me to connect with stories on a soulful level. Life
